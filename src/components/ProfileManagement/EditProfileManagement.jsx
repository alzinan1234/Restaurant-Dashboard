...
const EditProfileManagement = ({ onBackClick }) => {
  ...
  fileInputRefs.current = [...Array(4)].map(
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-3 rounded-lg border border-gray-400 focus:outline-none focus:border-blue-500 text-black"
            />
          </div>
          ...
          <div>
            ...
            <div className="rounded-lg ">
              <div
                className="flex flex-col items-center justify-center border border-dashed border-gray-400 rounded-lg h-32 cursor-pointer hover:border-blue-400 relative overflow-hidden" // Added relative and overflow-hidden
              ...
              <div className="grid grid-cols-3 gap-4 mt-4">
                {[1, 2, 3].map(
                  (
                    idx // Render remaining three upload sections
                  ) => (
                    <div
                      key={idx}
                      className="flex flex-col items-center justify-center p-4 border border-dashed border-gray-400 rounded-lg h-32 cursor-pointer hover:border-blue-400 relative overflow-hidden" // Added relative and overflow-hidden
              ...
              <table className="min-w-full text-black">
                ...
                <tbody>
                  {formData.operatingHours.map((hour, index) => (
                    <tr key={hour.day} className="border-t border-gray-300">
