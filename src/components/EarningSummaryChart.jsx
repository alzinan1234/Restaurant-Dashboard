...
export default function EarningSummaryChart() {
  ...
  return (
    ...
    <div
      ...
      className="w-full h-full p-2.5 bg-white rounded-lg flex flex-col justify-start items-center gap-5 text-black"
    >
      <div className="w-full flex justify-between items-center">
        {/* Changed text color to black */}
        <div className="text-black text-base font-medium font-['Roboto']">
          Earning Summary
        </div>
